...
class BHISeqDatasetProb(Dataset):
    ...
    def __init__(self,
        ...
        self.std = np.std(self.ds.score.values)
        self.mean = np.mean(self.ds.score.values)
    ...
    def __getitem__(self, i: int):
        ...
        """
        if len(self.ds.seq.values[i]) != 24:
